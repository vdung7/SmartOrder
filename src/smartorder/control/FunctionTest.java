...
import smartorder.presentation.MenuManagementPanel;
import smartorder.presentation.SaleStatisticPanel;
import smartorder.presentation.SalesReportChart;
import smartorder.presentation.UserStatisticPanel;

/**
 * @author vietdung
 *	This class just use for function testing
 */
@SuppressWarnings("all")
public class FunctionTest {
	public static void main(String[] args) {
		EntityManager em = Persistence.createEntityManagerFactory("SmartOrder")
				.createEntityManager();
		...
		try {
			...
			// set <property name="eclipselink.ddl-generation"
			// value="drop-and-create-tables"
			// in persistence.xml file and run below method
			// OrderHelper.initSampleData(em);

			/*
			 * // 2nd test - make order // shopping cart - put any productIDs
			 * into this cart ArrayList<CartItem> shoppingCart = new
			 * ArrayList<CartItem>(); // user choose some Product
			 ...
			 * make order with this shopping cart OrderHelper.makeOrder(em,
			 * shoppingCart, "vietdung7");
			 */
			...
			/*
			 * boolean res = CustomerHelper.register(em, "vantinh22",
			 * "123456789", "Duong V Tinh", "NVB TPHCM", "0974443645",
			 * "tinh@m.com"); System.out.println(res?"inserted":"duplicated");
			 */
			 ...
			 * System
			 * .out.println(c!=null?"loged in":"invalid username-password");
			 */

			// 6th test - view ORders
			/*
			 * for (String string : OrderHelper.getOrdersInString(em,
			 * "jackvt93")) { System.out.println(string); }
			 */
			...
			/*
			 * System.out.println(OrderHelper.getDetail(em,
			 * "ORD-2013-11-05-1383643170596"));
			 */
			...
			/*
			 * Product p = em.find(Product.class, 3); p.setRefPrice(1.2d);
			 */
			...
			// 11th test - HTML test
			/*
			 * JFrame f = new JFrame("test"); JLabel l = new
			 * JLabel(CustomerHelper.getPaymentReportByCustomer(em,
			 * "jackvt93")); l.setVerticalAlignment(SwingConstants.CENTER);
			 * l.setHorizontalAlignment(SwingConstants.CENTER); f.add(l);
			 * f.setSize(300, 300);
			 ...
			 * System.out.println(before+"\n"+after); for (FoodOrder o :
			 * OrderHelper.getByDate(em, before , after)) {
			 ...
			 * System.out.println(before+"\n"+after); for (FoodOrder o : fos) {
			 * System.out.println(o.getOrderDate()+" ; "+o.getCustomerID()); }
			 * 
			 * JFrame f = new JFrame("test 2 chart"); f.setSize(1000, 550);
			 * 
			 * SalesReportChart srch = new SalesReportChart(pid, fos, 1000);
			 * JPanel p = srch.createReportPanel(); f.add(new
			 * JLabel(em.find(Product.class, pid).getProductName()),
			 * BorderLayout.NORTH); f.add(p, BorderLayout.CENTER);
			 * f.setVisible(true);
			 */

			// 14th test - SaleStatictisPanel
			/*
			final JFrame f = new JFrame("test 2 chart");
			f.setSize(1000, 600);
			f.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
			f.add(new SaleStatisticPanel(em, 1000));
			...
			// 15th test - MenuManagementPanel
			/*
			 * JFrame f2 = new JFrame("test menu management"); f2.setSize(1000,
			 * 600); f2.setExtendedState(JFrame.MAXIMIZED_BOTH);
			 * f2.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE); f2.add(new
			 * MenuManagementPanel(em, f2.getHeight())); f2.setVisible(true);
			 */

			// 16th test - UserStatistic
			/*
			 JFrame f2 = new JFrame("test menu management"); f2.setSize(1000, 600);
			 f2.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE); 
			 f2.add(new	UserStatisticPanel(em)); 
			 f2.setVisible(true);
			 */
	...
	public static void initSampleData(EntityManager em) throws Exception {
		...
		em.persist(new Customer("vietdung7", "Viet Dung", "123456789",
				"Q.HM TPHCM", "0987356443", "vd@mail.com"));
		em.persist(new Customer("vanthi114", "Van Thi", "123456789",
				"Q.GV TPHCM", "0986676443", "thinv@mail.com"));
		em.persist(new Customer("jackvt93", "Luan Vu", "123456789",
				"Q.1 TPHCM", "0987354321", "jackvt@mail.com"));
