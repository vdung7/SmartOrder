	...
	public void actionPerformed(ActionEvent e) {
		...
		mServer = new TCPServer(new TCPServer.OnMessageReceived() {
			...
			public void requestReceived(ClientRequest request) {
				...
				switch (id) {
				case ClientRequest.LOGIN:
					receiveBoard.append(request.getUsername()+"-"+request.getPassword()+"\n");
					break;
				case ClientRequest.LOGOUT:
					receiveBoard.append("\n");
					break;
				case ClientRequest.ORDER:
					...
					break;
				case ClientRequest.REGISTER:
					receiveBoard.append(request.getUsername()+";"+request.getPassword()+";"+request.getName()+";"
				...
				case ClientRequest.UPDATE:
					...
					break;
				default:
					receiveBoard.append("Oop..! I don't know what happened  >\"<");
					break;
				}
			}
		});
