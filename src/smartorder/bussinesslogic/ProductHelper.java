...
public class ProductHelper {
	...
	public static ArrayList<String> getMenuInStringArray(EntityManager em) throws Exception {
	...
	public static ArrayList<String> getMenuByAvailable(EntityManager em, boolean available) {
