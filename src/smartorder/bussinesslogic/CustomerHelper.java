...
public class CustomerHelper {
	...
	public static Customer checkLogin(EntityManager em, String userID, String password) throws Exception {
	...
	public static boolean register(EntityManager em, String newID, String password, String name, String address,
		String phone, String email) throws Exception {
		if(em.find(Customer.class, newID)==null){
			em.persist(new Customer(newID, name, password, address, phone, email));
			return true;
		}
		return false;
	}
	...
	public static String getDetailInHTML(EntityManager em, String uid) {
		...
		detail+= "<li><b>Username: </b><font color=blue>"+c.getCustomerID()+"</font><br>";
	...
	public static String getPaymentReportByCustomer(EntityManager em, String userID) {
		// get customer
		...
		// HTML report
		String report = "<html><ul>"
				+ "<li>Total Payment: "
				+ "<font color=red size=+1>$" +String.format("%2.2f", totalPayment)+ "</font>" 
				+ "<li>Total Order: "
				+ "<font color=red>" +totalOrder+ "</font>" 
				+ "<li>Payment per Order: "
				+ "<font color=red>$" +String.format("%2.2f", totalPayment/totalOrder)+ "</font>" 
				+ "</ul></html>";
